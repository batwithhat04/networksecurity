...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        It initiates a KNNImputer object with prameters specified in the training_pipeline.py file and returns a pipeline object with the KNNImputer 
        object as the first step.

        Args: cls: The class of the DataTransformation object.
        Returns: A pipeline object with the KNNImputer object as the first step.
        """
        logging.info("Entered get_data_transformer_object method of DataTransformation class")
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info(f" KNNImputer object created with {DATA_TRANSFORMATION_IMPUTER_PARAMS}") 
